...
export interface ApiCategoryDishCategoryDish
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_dishes';
  info: {
    description: '';
    displayName: 'Category Dish';
    pluralName: 'category-dishes';
    singularName: 'category-dish';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-dish.category-dish'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiCategoryVideoCategoryVideo
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_videos';
  info: {
    description: '';
    displayName: 'Category Video';
    pluralName: 'category-videos';
    singularName: 'category-video';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-video.category-video'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    add: Schema.Attribute.DynamicZone<
      ['elements.add-radio-list', 'elements.add-checkbox-list']
    >;
    badges: Schema.Attribute.Relation<'oneToMany', 'api::badge.badge'>;
    category_dish: Schema.Attribute.Relation<
      'manyToOne',
      'api::category-dish.category-dish'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiLandingpageLandingpage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['sections.video-section', 'sections.menu-section', 'sections.hero']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category_video: Schema.Attribute.Relation<
      'manyToOne',
      'api::category-video.category-video'
    >;
    createdAt: Schema.Attribute.DateTime;
